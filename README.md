...
| `skills/pentest/` | 14 | pentest-tools, attack-chain, recon-pipeline, nmap, nuclei, ffuf, sqlmap, netexec, password-cracking, js-api-extract, source-leak-hunt, wifi-wireless |
