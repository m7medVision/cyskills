...
| `skills/pentest/` | 15 | pentest-core (engine: web/mobile/infra class sets), pentest-tools, attack-chain, recon-pipeline, nmap, nuclei, ffuf, sqlmap, netexec, password-cracking, js-api-extract, source-leak-hunt, wifi-wireless |
