...
代码骨架见 `unhook-techniques.md` 与 `telemetry-blinding.md`。
...
- 详细 hook 调研：`hook-survey.md`
- unhook / syscall 技术：`unhook-techniques.md`
- ETW / AMSI / 反取证：`telemetry-blinding.md`
