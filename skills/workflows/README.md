...
| --- | --- | --- |
| [workflow-web-pentest](./workflow-web-pentest/SKILL.md) | website / HTTP API | pentest-core, web-pentest, recon, JS/source extraction, nuclei, mitmproxy, browser |
| [workflow-mobile-pentest](./workflow-mobile-pentest/SKILL.md) | Android app + backend | pentest-core, mobile-pentest, mitmproxy, APK/mobile RE, source-leak-hunt |
| [workflow-infra-pentest](./workflow-infra-pentest/SKILL.md) | CIDRs / hosts / services | pentest-core, infra-pentest, nmap, recon, netexec, password-cracking, nuclei |
