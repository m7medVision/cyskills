...
| Upload reaches an application parser or extractor | Use `file-parser-chain` |
| Archive is only a carrier for hidden media data | Use `stego-media` |
...
- a provided template or source file;
