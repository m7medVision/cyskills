#!/usr/bin/env bash
# recon.sh — radare2 quick recon (binary basic info, sections, imports/exports, strings)
...
ensure_tool() {
    ...
    echo "INFO: $name not found, attempting install..."
...
if [[ "$RUN_ANALYSIS" == "true" ]]; then
    echo ""
    echo "=== Function and entry analysis ==="
