# Frida Practical Script Cookbook

> Curated from open-source projects such as [awesome-frida](https://github.com/dweinstein/awesome-frida), [Frida-Mobile-Scripts](https://github.com/m0bilesecurity/Frida-Mobile-Scripts), and [frida-codeshare-scripts](https://github.com/zengfr/frida-codeshare-scripts).
> Categorized by scenario, ready to copy and use.

---

## Generic Hook Templates

### Hook an Arbitrary Java Method

```javascript
Java.perform(function() {
    var TargetClass = Java.use("com.target.ClassName");
    
    // Hook a no-argument method
...
Java.perform(function() {
    ...
    // Hook newCall to obtain the request URL
    ...
    Interceptor.attach(fopen, {
        ...
        onLeave: function(retval) {
            if (this.path && this.path.indexOf("/proc/") !== -1 && this.path.indexOf("/status") !== -1) {
                // Can further hook fgets to modify TracerPid
            }
        }
    });
});
            ...
            try {
                ...
                for (var i = 0; i < dexElements.length; i++) {
                    ...
                    if (dexFile) {
                        ...
                        // Can further dump the dex content
                    }
                }
            } catch(e) {}
        },
...
|------|------|------|
| Frida official docs | API reference | https://frida.re/docs/ |
| Frida CodeShare | Community script sharing | https://codeshare.frida.re/ |
| awesome-frida | Comprehensive resource collection | https://github.com/dweinstein/awesome-frida |
| frida-codeshare-scripts | The most comprehensive script collection on the web | https://github.com/zengfr/frida-codeshare-scripts |
